    ...
    <section className="section founder-note" id="note">
      <div className="wrap founder-note-wrap">
        ...
        <Reveal as="p" className="founder-note-body" delay={0.08}>
          ...
          on — and your job is to grow it like it's yours. I go past the ad account
          when I have to, because the goal was never good metrics; it was your
          business working. The founders I do my best work with feel the same way.
          That shared belief is the whole game.
        </Reveal>
      </div>
    </section>
  );
